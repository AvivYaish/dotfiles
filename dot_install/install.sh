...
brew analytics off
for app in neovim chezmoi zoxide rs/tap/curlie bat lsd git-delta ripgrep sd universal-ctags tealdeer fd nvm byobu fzf yazi procs bottom glow googler ddgr; do
  case ${app} in
