...
for app in wget neovim zsh git chezmoi zoxide curlie bat lsd git-delta ripgrep sd ctags tealdeer nodejs fd byobu fzf yazi procs bottom glow openjdk-17 libzmq pandoc; do
  pkg install ${app}
done
