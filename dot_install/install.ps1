foreach ($app in @('Mozilla.Firefox', 'KeePassXCTeam.KeePassXC', 'sorairolake.qrtool', 'Microsoft.PowerShell', 'Git.Git', 'twpayne.chezmoi', 'JanDeDobbeleer.OhMyPosh', 'junegunn.fzf', 'lsd-rs.lsd', 'ajeetdsouza.zoxide', 'dalance.procs', 'chmln.sd', 'dbrgn.tealdeer', 'BurntSushi.ripgrep.MSVC', 'dandavison.delta', 'jftuga.less', 'sharkdp.bat', 'sharkdp.fd', 'pnpm.pnpm', 'Clement.bottom', 'ca.duan.tre-command', 'JohnMacFarlane.Pandoc', 'OpenJS.NodeJS', 'Neovim.Neovim', 'UniversalCtags.Ctags', 'sxyazi.yazi', 'ImageMagick.ImageMagick', 'oschwartz10612.Poppler', 'jqlang.jq', 'charmbracelet.glow', 'PaddiM8.kalker', 'Pinta.Pinta', 'Microsoft.PowerToys', 'Microsoft.VisualStudioCode', '7zip.7zip', 'Dell.DisplayManager', 'PeterPawlowski.foobar2000', 'VideoLAN.VLC', 'Audacity.Audacity', 'dotPDN.PaintDotNet', 'Gyan.FFmpeg', 'martinrotter.RSSGuard', 'OpenWhisperSystems.Signal', 'dokan-dev.Dokany', 'qBittorrent.qBittorrent', 'Soulseek.SoulseekQt', 'yt-dlp.yt-dlp', 'Joplin.Joplin', 'Dropbox.Dropbox', 'Zoom.Zoom', 'DigitalScholar.Zotero', 'PDFArranger.PDFArranger', 'Anaconda.Anaconda3', 'Docker.DockerDesktop', 'Logtiech.OptionsPlus')) {winget install $app}
...
foreach ($app in @('urlwatch', 'ptpython', 'visidata', 'windows-curses', 'epy-reader', 'pynvim')) {pip install $app}
